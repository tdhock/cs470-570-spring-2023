...
anaconda]]), I recommend using an IDE where you can see the code and
send lines interactively to an interpreter, such as [[https://github.com/tdhock/cs499-599-fall-2022/blob/main/installation.org][emacs]].
