...
Part 0 Deliverable consists of the following:
...
- Overview: Similar to part 0, but now extended to focus on the
  creation of your intelligent Halma agent. Condense your description
  of the basics from Part0 (labeling them as "Part0" pieces), but
  leave them in so as to give a complete picture. Then add in
  (labeling as Part 0) what objects/classes you added to upgrade your
...
- Functionality Checklist. Just as for Part 0, but now has the
